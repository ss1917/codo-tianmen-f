<template>
  <div style="height:100%">
    ...
    <app-edit :modalData="modalData" :formValidate="theData"  @handle-submit-app="saveApp" @close="handleDrawerClose" />
  </div>
</template>

<script>
import { mapState } from 'vuex'
import { getApplist, optApp } from '@/api/auth/apps'
...
export default {
  ...
  data () {
    return {
      ...
      tableData: [],
      columns: [
        { title: '应用编码', key: 'app_code', minWidth: 80, maxWidth: 150, sortable: true },
