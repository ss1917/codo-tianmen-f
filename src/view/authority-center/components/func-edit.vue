<template>
  <Drawer v-model="modalEditData.show" :title="modalEditData.title" width="850px;" draggable :footer-hide=true>
    ...
    handleSubmit (name) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          setTimeout(() => {
            this.$emit('handle-submit-func', this.formValidate, this.modalEditData.action)
